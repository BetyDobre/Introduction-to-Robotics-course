#ifndef _NOTES_H    // Put these two lines at the top of your file.
#define _NOTES_H
...
int loseMelody[] = {
  ...
  NOTE_E4,2, REST,4, REST,8, NOTE_DS4,
 
};

const int startMelody[] PROGMEM = {
...
void loseTone() {
  ...
  if(!oneTime) {
    for (int j = 0; j < notes * 2; j = j + 2) {
      ...
      tone(buzzerPin, loseMelody[j], noteDuration * 0.9);
      delay(noteDuration);
      noTone(buzzerPin);
      oneTime = true;
